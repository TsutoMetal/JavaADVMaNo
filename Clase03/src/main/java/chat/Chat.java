...
public class Chat extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txaChat.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N
        txaChat.setRows(5);
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        try(Socket so=new Socket(
                MapaDirecciones.getMapa().get(cmbLista.getSelectedItem()),7000);
                OutputStream out=so.getOutputStream();
                ) {
                out.write(txtMensaje.getText().getBytes());
                txtMensaje.setText("");
                txtMensaje.requestFocus();
                txaChat.append("Se envio mensaje a "+cmbLista.getSelectedItem()+".\n");
